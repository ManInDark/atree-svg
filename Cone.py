...
if __name__ == "__main__":
    ...
    for e in list_2:
        s_2 += e.pathPrint("L") + " "
    print("<style>body{margin:0px;background: rgb(236,192,116);} path:nth-child(1){d:path('"+s_1.replace("L", "M", 1)+"');}")
    ...
    print('<svg viewBox="0 0 80 100" height="100vh" style="display:block;margin:auto;"><path stroke="blue"/><path stroke="red"/></svg>')
